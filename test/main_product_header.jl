...
@testset "Read header" begin
    ...
    @test record_header.record_class ==
          MetopNative.get_record_class(MetopNative.MainProductHeader)
    ...
    @test main_header isa MetopNative.MainProductHeader
    ...
    @test MetopNative.data_record_type(main_header) == MetopNative.ASCA_SZO_1B_V13
end
